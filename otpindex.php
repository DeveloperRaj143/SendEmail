...
<body>
    <div class="container">
<form class="mt-5" method="POST" action="otp.php">
  ...
  <!-- Submit button -->
  <button data-mdb-ripple-init type="submit" name="submitContact" class="btn btn-primary btn-block mb-4">Send otp</button>
</form>
</div>
